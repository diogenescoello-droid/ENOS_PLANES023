# Diccionario de elementos operativos — v0.5.7
...
La capa incluida en v0.5.7 es demostrativa. No representa datos oficiales. Su propósito es validar comportamiento de mapa, filtros, semáforos y fichas.
